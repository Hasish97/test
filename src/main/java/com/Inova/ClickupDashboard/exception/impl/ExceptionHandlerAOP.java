...
import com.Inova.ClickupDashboard.dtos.common.ResponseDTO;
    ...
    public Object advice(ProceedingJoinPoint proceedingJoinPoint, ResponseExceptionHandler exceptionHandler) {
        ...
        try {
            ...
            if (!(response.getBody() instanceof ResponseDTO)) {
                ...
                responseDTO.setStatus(App_constants.ResponseStatus.SUCCESS);
            ...
            if (e instanceof BaseException) {
                ...
                responseDTO.setStatus(App_constants.ResponseStatus.FAILED);
